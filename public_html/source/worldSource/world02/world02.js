...
if(currentStage < 8) {
    document.getElementById("World3Door").style.backgroundImage = "url('../assets/portalClosed.gif')";
} else {
    document.getElementById("World3Door").style.backgroundImage = "url('../assets/portalOpen.gif')";
