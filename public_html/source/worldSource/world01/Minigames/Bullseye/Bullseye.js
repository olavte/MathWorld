...
function hitTest(tween) {
    ...
    if (intersection.segment1 && intersection.segment2) {
        ...
        if (distance < 7) {
            ...
            document.getElementById('bullseyeScore').innerHTML = "Score:" + totalScore;
           //decreaseArrows();
...
function decreaseArrows(){
    ...
    document.getElementById('numarrows').innerHTML = "Arrows: " + numArrows;  
    
    if(numArrows === 0){
        
        goToNewScreen('source/mainMenuSource/startScreen/startScreen.html', 'source/mainMenuSource/startScreen/startScreen.js');
    }
